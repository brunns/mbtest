...
latex_documents = [
    (master_doc, 'mbtest.tex', 'mbtest Documentation',
     'Simon Brunning', 'manual'),
]
...
man_pages = [
    (master_doc, 'mbtest', 'mbtest Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'mbtest', 'mbtest Documentation',
     author, 'mbtest', 'One line description of project.',
     'Miscellaneous'),
]
